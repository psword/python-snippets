...
def regex_sort(file):
    ...
    print("\nIf you are processing URLs, the items will be merged with the master list.\n")
...
def combination():
    ...
    file_input_combo = open("//sharepath/master_list.txt", "rt")
    ...
    file_input1_combo = open("c:/temppath/file_output.txt","rt")
    ...
    file_output_combo = open("//sharepath/master_list.txt", "wt")
...
def masterlistsort():
    ...
    master_list_read = open("//sharepath/master_list.txt", "rt")
    ...
    #print(master_list_dedupe)

    master_list_write = open("//sharepath/master_list.txt", "wt")
